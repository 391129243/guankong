...
import com.learn.all_electric.adapter.WifiConnectAdapter;
...
public class WlanConnectActivity extends BaseActivity {
	...
	protected void initViews(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		RelativeLayout mTitleLayout = (RelativeLayout)findViewById(R.id.wifi_title_layout);
	...
	private void registerReceiver(){
		wifiReceiverActionListener = new WifiReceiverActionListener() {
			...
			public void onWifiResultBack(List<ScanResult> list) {
				Log.i("wifi", "onWifiResultBack" + list.size());
				// TODO Auto-generated method stub
				/***已经连接的wifi**/
				if(list.size() > 0){
			...
			public void onWifiOpened() {
				// TODO Auto-generated method stub
				mWifiStatusTxt.setText(R.string.wifi_open);
			}
			...
			public void onWifiClosed() {
				...
				closeWifi();
				mWifiStatusTxt.setText(R.string.wifi_close);
				scanResultList.clear();
				mWifiScanList.clear();
	...
	private void connecStatus(boolean flag){
		if(flag){
			conStatusTxt.setText(R.string.wifi_connecting);
	...
	private void hideSoftInputMethod(){
		InputMethodManager im = (InputMethodManager)WlanConnectActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
...
/**********************************************************************************************************/
	...
	private void showConnectWifiDialog(final ScanResult scanResult){
		...
		if(null == connectDialog){
			...
			builder.setConnectButton(R.string.dialog_wifi_connect, new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface arg0, int arg1) {
					...
					if(pwd.equals("")){
						displayToast(R.string.wifi_toast_null);
						return; 
					}
					if(pwd.length() < 8){
						displayToast(R.string.wifi_toast_length);
						return; 
					}
     ...
     * **/
	private void showForgetWifiDialog(MScanWifi scanWifi){
		if(null != forgetDialog){
			forgetDialog.dismiss();
			forgetDialog = null;
		}
		...
		if(null == forgetDialog){
			...
			statusTv.setText(mContext.getString(R.string.wifi_connect));
			signalTv.setText(scanWifi.getWifiLevel()+"");			
			securityTv.setText(scanWifi.getSecurityMode() + "");
			builder.setForgetButton(R.string.dialog_wifi_forget, new DialogInterface.OnClickListener() {
	...
	public static class UIHandler extends Handler{
		...
		public void handleMessage(Message msg) {
			...
			case MSG_WIFI_SCANRESULT:
				Log.i(TAG, "MSG_WIFI_SCANRESULT" + mActivity.mWifiScanList.size());
			...
			case MSG_WIFI_TURN_OFF:
				...
				mActivity.seachingTxt.setText(R.string.wifi_turn_off_status_hint);
